...
export default function Home() {
  ...
  useEffect(() => {
    const retrievedData = getData(
      `https://frontend-applications-eight.vercel.app/api/popular`,
      pageNum
    );
      ...
      <main>
        <section className={style.gridContainer}>
          ...
          <div className={style.card}>
            <h2>Information</h2>
            <p>
              The graph shows the current popularity of actors based on the
              dataset of TheMoviedatabase. With some knowledge of the currently
              playing movies you will instantly see that the higher rated actors
              are from movies that recently released some form of media.{' '}
            </p>
